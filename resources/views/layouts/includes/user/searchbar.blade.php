            ...
            <form method="GET" action="">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        <input type="text" autocomplete="off" placeholder="Qui, quoi ? ( activité, produit, service, nom d'entreprise ou professionnel.. sur le Maroc)" required="required" name="string" class="form-control"/>
