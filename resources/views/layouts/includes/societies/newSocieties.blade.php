                    ...
                    <div class="society-card">
                        <div class="image-card">
                            <a href="#" class="listing-thumb">
                                <img decoding="async" src="/storage/{{ $society->image }}" class="img-responsive"
                                    alt="">
                            </a>
                            <span
                                class="list-rate">{{ $society->rating['ratingOfSocietie'] == 0 ? 'No Reviews Yet' : $society->rating['ratingOfSocietie   '] }}</span>
                        </div>
                        ...
                        <div class="listing-footer-info">
                            <div class="listing-card-info-icon">
                                <i class="fa-solid fa-user-tie" style="color: #fafafa;"></i> <span
                                    class="sous-inf"><b>Categorie: </b>{{ $society->categorie->name }}</span>
                            </div>
                        </div>
                    </div>
                </div>
