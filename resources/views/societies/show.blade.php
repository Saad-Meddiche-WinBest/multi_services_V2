                            ...
                            <div class="rate-overall rate-high">
                                ...
                                @if ($rating['ratingOfSocietie'] >= 2.5)
                                    ...
                                    @elseif($rating['ratingOfSocietie'] == 0)
                                        <div class="overrate-box" style="color: blue;border:1px dashed blue">
                                            {{ $rating['ratingOfSocietie'] }}</div>
                                        <div class="overrate-box-caption">
                                            <span style="color:blue">No reviews</span>
                                        @else
                                            <div class="overrate-box" style="color:red;border:1px dashed red">
                                                {{ $rating['ratingOfSocietie'] }}</div>
                                            <div class="overrate-box-caption">
        ...
        <div class="container">
            <div class="details-section">
                <div class="left-details">
                    ...
                    {{-- Maps --}}
                    @if (isset($societie->coordinations))
                        <div class="description-details">
                            <div class="description-title">
                                <h1>Location</h1>
                            </div>
                            <div class="description-content" style="width:100%;height:100%">
                                {!! $societie->coordinations !!}
                            </div>
                        </div>
                    @endif

                    {{-- Youtube --}}
                    @if (isset($societie->video))
                        <div class="description-details">
                            <div class="description-title">
                                <h1>Video</h1>
                            </div>
                            <div class="description-content">
                                @php
                                    parse_str(parse_url($societie->video)['query'], $query);
                                @endphp
                            ...
                            <div class="description-details">
                                ...
                                <div class="description-content" id="forms">
                                    ...
                                    <form action="{{ route('review.destroy', $reviewOfLoggedUser->id) }}"
                                        style="padding-top:20px" method="post">
                                        @csrf
                                        @method('delete')
                                        <input type="hidden" name="societie_id" value="{{ $societie->id }}">
                        ...
                        <div class="google">
                            ...
                            <div class="google-sign-up">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                    viewBox="0 0 488 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                    <style>
                                        svg {
                                            fill: #ca0216
                                        }
                        ...
                        <div class="agent-widget">
                            ...
                            <div id="listing-equiry-form">
                                <form action="{{ route('mail', ['societie' => $societie->id]) }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" required="" name="message" placeholder="Send Message to author..."
                        ...
                        <div class="time-horaire">
                            <div class="description-title">
                                <div class="description-title-left">
                                    <i class="fa fa-clock"
                                        style="color:#17bd62;padding:5px;"></i><span><b>SCHEDULE</b></span>
                                </div>
            ...
            <div class="description-details">
                ...
                <div class="tr-single-body">
                    ...
                    @if (isset($societie->facebook) || isset($societie->instagram) || isset($societie->twitter) || isset($societie->linkdin))
                        <div class="single-follow-us-social-icon">
                            <h5>Follow Us</h5>
                            <ul>
                                @if (isset($societie->facebook))
                                    <li>
                                        <a href="{{ $societie->facebook }}">
                                ...
                                @if (isset($societie->instagram))
                                    <li>
                                        <a href="{{ $societie->instagram }}">
                                ...
                                @if (isset($societie->twitter))
                                    <li>
                                        <a href="{{ $societie->twitter }}"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                @if (isset($societie->linkdin))
                                    <li>
                                        <a href="{{ $societie->linkdin }}"><svg xmlns="http://www.w3.org/2000/svg"
